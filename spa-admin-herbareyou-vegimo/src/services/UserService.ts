...
export class UserService extends BaseService {
  ...
  async storeApi(search: any = {}): Promise<any> {
    console.log(search);
    return await this.post(ApiUrls.users(), search)
      .then((response) => {
  ...
  async indexApi(search: any = {}): Promise<any> {
    console.log(search);
    return await this.get(ApiUrls.users(), search)
      .then((response) => {
        return this.baseSuccess(response);
      })
      .catch((error) => {
  ...
  async showApi(id: number): Promise<any> {
    return await this.get(ApiUrls.users(id))
      .then((response) => {
        return this.baseSuccess(response);
      })
      .catch((error) => {
  ...
  async updateApi(id: number, data: any): Promise<any> {
    return await this.put(ApiUrls.users(id), data)
      .then((response) => {
        return this.baseSuccess(response);
      })
      .catch((error) => {
  ...
  async destroyApi(id: number): Promise<any> {
    return await this.delete(ApiUrls.users(id))
      .then((response) => {
        return this.baseSuccess(response);
      })
      .catch((error) => {
