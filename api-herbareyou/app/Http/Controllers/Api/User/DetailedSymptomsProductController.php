...
class DetailedSymptomsProductController extends BaseController
{
    ...
    {
        $model = new DetailedSymptomProduct;
        $data = $model->getNameFromSymptom($request['name'], $request['id']);
        return $this->sendResponse($data);
    }
}
