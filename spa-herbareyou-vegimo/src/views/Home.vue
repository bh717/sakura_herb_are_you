    ...
    <main class="main">
      <article>
        ...
        <div class="full-img" data-anime="fadeup">
          <picture>
            <source media="(max-width:599px)" srcset="@/assets/img/top/top2.png" />
        ...
        <section class="sec sec--gray">
          <div class="sec-sub-container">
            <h2 class="sec-container__hd2 sec-container__hd2--mb5 sec-container__hd2--lh" data-anime="fadeup">
              ...
              <span class="sec-container__hd2-ja">植物療法士がお届けする暮らしとハーブのコラムです</span>
            </h2>
            <ul class="blog-list">
        ...
        <section class="sec">
          <div class="sec-container">
            <h2 class="sec-container__hd2 sec-container__hd2--mb5 sec-container__hd2--lh" data-anime="fadeup">
              <span class="sec-container__hd2-en">RECOMMENDATION FOR {{ monthAlphabet() }}</span>
              <span class="sec-container__hd2-ja">季節のおすすめからハーブティを探す</span>
            </h2>
