            ...
            <article v-if="isShow">
                <section class="sec">
                    <div class="sec-container">
                        <h2 class="sec-container__hd2">「{{ symptoms[Number(symptomIds) - 1].name }}」 に関する商品</h2>
                        <div class="sort">
                            ...
                            <div class="sort-left">
                                <div class="accordion" id="js-filter">
                                    <div class="accordion__container">
                                        ...
                                        <div class="accordion__content">
                                            <ul class="sort-inner-list">
                                                <li class="sort-inner-item" v-for="symptom in symptoms"
                                                    v-bind:key="symptom.id">
                                                    <input type="checkbox" :id="'symptom-' + String(symptom.id)"
                                                        name="categories" :value="symptom.id" v-model="symptomIds"
                                                        class="sort-inner-item__check"
                                                        :checked="symptomIds.includes(symptom.id)" />
                                                    <label :for="'symptom-' + String(symptom.id)"
                                                        class="sort-inner-item__label">{{ symptom.name }}</label>
                                                </li>
                                            </ul>
                                        </div>
                                    </div>
                                    <div class="accordion__container">
                                        ...
                                        <div class="accordion__content">
                                            <ul class="sort-inner-list">
                                                <li class="sort-inner-item" v-for="taste in tastes"
                                                    v-bind:key="taste.id">
                                                    <input type="checkbox" :id="'taste-' + String(taste.id)"
                                                        name="categories" :value="taste.id" v-model="tasteIds"
                                                        class="sort-inner-item__check"
                                                        :checked="tasteIds.includes(taste.id)" />
                                                    <label :for="'taste-' + String(taste.id)"
                                                        class="sort-inner-item__label">{{ taste.name }}</label>
                                                </li>
                                            </ul>
                                        </div>
                                    </div>
                                    <div class="accordion__container">
                                        ...
                                        <div class="accordion__content">
                                            <ul class="sort-inner-list">
                                                <li class="sort-inner-item" v-for="material in materials"
                                                    v-bind:key="material.id">
                                                    <input type="checkbox" :id="'material-' + String(material.id)"
                                                        name="categories" :value="material.id" v-model="materialIds"
                                                        class="sort-inner-item__check"
                                                        :checked="materialIds.includes(material.id)" />
                                                    <label :for="'material-' + String(material.id)"
                                                        class="sort-inner-item__label">{{ material.name }}</label>
                                                </li>
                                            </ul>
                                        </div>
                                    </div>
                                ...
                                <div class="sort-right">
                                    <div class="accordion">
                                        <div class="accordion__container accordion__container--pr0">
                                            <a
                                                class="accordion__title accordion__title--exc js-accordion-title">並び替え</a>
                                            <div class="accordion__content">
                                                <ul class="sort-inner-list">
                                                    <li class="sort-inner-item"
                        ...
                        <ul class="product-list clearfix" v-if="products.length !== 0">
                            <li class="product-item" data-anime="fadeup" :data-category="'att-' + String(product.id)"
                                ...
                                <p class="product-item__ttl">
                                    ...
                                    <span class="product-item__ttl-main">{{ product.name1 }}　¥{{ product.prices[0].price
                                    }}</span>
                                </p>
