      ...
      <article id="app" v-if="isSecondShow">
        <section class="sec">
          <div class="sec-container">
            ...
            <div class="sec-container__btn" v-if="diagnoseData.diagnose2.condition !== 14">
              <button type="button" class="sec-container__btn-inner" v-on:click="nextPage()">
                次の質問へ
              </button>
            </div>
...
export default defineComponent({
  ...
  methods: {
    init: async function () {
      ...
      const DetailedSymptomsApiResult = await showDetailedSymptomsApi(Number(this.diagnoseData.diagnose2.condition));
...
<style scoped src="@/assets/css/diagnose-3.css">
